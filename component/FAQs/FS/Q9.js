  ...
  return (
    <>
      ...
      <div className={styles.quebtn}>
        <span onClick={() => setToggle(!toggle)}>  9. What Projects Will I Work on During the Course? </span>  <FaPlusSquare onClick={() => setToggle(!toggle)} className={styles.plusicon} /> </div>
